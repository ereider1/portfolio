        ...
        <div className="hero-container">
          ...
          <main className="hero-main-content">
            ...
            <div className="hero-right-text">
              <h2 className="hero-tagline">I build fast, intelligent, beautifully designed web experiences—combining modern front-end development with AI to turn ambitious ideas into working products.</h2>
